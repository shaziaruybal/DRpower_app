      ...
      tabItem(
        ...
        fluidRow(
          column(width = 12,
                 ...
                 "1.	In the ", strong(shinyLink(to = "design", label = "design phase")), "(before data have been collected) to help guide the appropriate number of clusters and a sample size per cluster.",
                 br(),
                 ...
                 img(src = "img/analysis_phase_v2.png", height = "75%", width = "75%"),
                 br(), br(),
        ...
        fluidRow(
            column(width = 12, 
                   ...
                   div(class = "custom-callout",
                       p(class = "callout-title", "How many samples? How many clusters?"),
                       "The table below gives the number of confirmed malaria positive samples required ", em("per cluster "), "in order for study power to be 80% or higher. You can use these numbers as a general guide when scoping out a study plan, before moving to more tailored sample sizes in the ",
                   ...
                   box(width = 12,
                       ...
                       bsTooltip("ss_icc", 
                                 ...
                                 title = "A high ICC value implies a high variation in the prevalence of deletions between clusters. A value of 0.05 is suggested by default based on an analysis of historical studies (see the DRpower website).",
                                 placement = "right",
          ...
          column(width = 12,
            ...
            tabsetPanel(type = "tabs",
                        tabPanel("Final cluster sizes",
                                 br(),
                                 div(class = "custom-callout",
                                     p(class = "callout-title", "Refine your cluster sizes"),
        ...
        fluidRow(
          column(width = 12, style='padding:20px;', 
                 Callout(
                   ...
                   br(), br(),
                   "Intra-cluster correlation refers to the variation between clusters, i.e. how ", em("overdispersed"), " they are.", 
                   br(), br(),
                   "Imagine we are undertaking a survey to estimate whether the ", em("pfhrp2/3"), " gene deletion prevalence is above the 5% threshold at the province-level and we sample from multiple clusters (e.g. sentinel sites/health facilities). Due to many factors, there may be differences in the cluster-level prevalences and this variation will impact the estimation of overall province-level prevalence. ",
                   "High ICC would mean there is a lot of variation in the prevalence of gene deletions between clusters, which will in turn lead to higher uncertainty in our province-level estimate and require larger sample sizes. The Bayesian model in DRpower takes into account ICC to more robustly estimate a 'mean' province-level prevalence. ",
                   br(), br(),
